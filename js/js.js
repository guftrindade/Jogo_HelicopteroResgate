function start() { // Inicio da função start()
    ...
    var jogo = {}
    var TECLA = { //CADA LETRA É DEFINIDA COM UM VALOR DECIMAL
        W: 87,
        S: 83,
        D: 68
    }
    var podeAtirar=true;
    var fimdejogo=false;
    var velocidade=5; //DEFININDO A POSIÇÃO RANDOMICA DO INIMIGO 1
    ...
    function movejogador() {
        ...
        function disparo() {
            ...
            somDisparo.play();
            podeAtirar=false; //SÓ PODE ATIRAR SE NÃO TIVER OUTRO TIRO NA TELA
